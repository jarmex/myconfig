...
local config = {
  ...
  cmd = {
    ...
    '-jar', '/Users/jamo/opt/jdt-language-server/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',
    '-configuration', '/Users/jamo/opt/jdt-language-server/config_mac',
    '-data', workspace_dir,
  },
